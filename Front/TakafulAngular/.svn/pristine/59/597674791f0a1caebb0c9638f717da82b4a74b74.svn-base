...
$(document).ready(function () {
  ...
  function rowInlineEditing(element) {
    var editIcon = element.children().first().children().first();
    //Editing
    if (editIcon.hasClass("fa-pencil-alt")) {
      editIcon.removeClass("fa-pencil-alt").addClass("fa-save");
      element.children(".row-inline-editable").addClass("active");
    }
    //Saving
    else if (editIcon.hasClass("fa-save")) {
      //console.log("Save Mode");
      editIcon.removeClass("fa-save").addClass("fa-pencil-alt");
      element.children(".row-inline-editable").each(function (index, value) {
        ...
        if (select.length) {
          ...
          if (checkbox.is(":checked")) {
            ...
            $(this).parents("td").data("filter", "Active"); //---------------------------------------- search active in table
          } else {
            ...
            $(this).parent("td").data("filter", "Not Active"); //------------------------------------ search active in table
          }
        }
      });
